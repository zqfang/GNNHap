...
def add_train_args():
    ...
    parser.add_argument("--num_epochs", default=100, type=str, help="num_epochs for training")
    parser.add_argument("--batch_size", default=200000, type=int, help="batch size (num_edges) for mini-batch training and testing")
    parser.add_argument("--num_cpus", default=6, type=int, help="Number of cpus for dataloader")
